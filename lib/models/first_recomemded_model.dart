...
//
//     final firstRecomemdedModel = firstRecomemdedModelFromJson(jsonString);

import 'dart:convert';

FirstRecomemdedModel firstRecomemdedModelFromJson(String str) => FirstRecomemdedModel.fromJson(json.decode(str));

String firstRecomemdedModelToJson(FirstRecomemdedModel data) => json.encode(data.toJson());

class FirstRecomemdedModel {
    bool? status;
    Data? data;

    FirstRecomemdedModel({
        this.status,
        this.data,
    });

    factory FirstRecomemdedModel.fromJson(Map<String, dynamic> json) => FirstRecomemdedModel(
        status: json["status"],
