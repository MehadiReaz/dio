    ...
    return Scaffold(
      backgroundColor: Colors.white,
        body: Obx(() {
          if (controller.isLoading.value) {
          ...
          } else if (controller.fRModel.value.data?.data?.isEmpty??true) {
            ...
            return Container(
              ...
              child: ListView.separated(
                ...
                itemCount: controller.fRModel.value.data?.data?.length ?? 0,
                scrollDirection: Axis.vertical,
                itemBuilder: (context, index) {
                  var fRData = controller.fRModel.value.data?.data?[index];
                  return Container(
                    width: double.infinity,
                        ...
                        Row(
                          children: [
                            detalsview(
                                ...
                                (){
                                  ...
                                  tapApprovedDetailsdialog(
                                    (){
                                    controller.firstRecomemdedApproval(
                                      fRData.id!.toInt());
                                  print(fRData.id);
                                  Get.back();
                                  controller.frecomededNoteController.value
                                  .clear();
                                  controller.pendingfirstrecomeded();
                                  });
                                },
                                (){
                                  controller.cancleRecomemdedApproval(fRData.id!.toInt());
                            ...
                            iconView(Icons.close, Colors.red, () {
                              tapApprovedcvancle(() {
                               controller.cancleRecomemdedApproval(
                                      fRData.id!.toInt());
                                  print(fRData.id);
                                  Get.back();
                                  // controller.frecomededNoteController.value
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          TextFormField(
            maxLength: 30,
            controller: controller.frecomededNoteController.value,
            decoration:
