...
class _ApprovalPageState extends State<ApprovalPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      if (controller.isapprovedLoading.value) {
      ...
      } else if (controller.approvalModel.value.data?.data?.isEmpty ?? true) {
        ...
        return Container(
          ...
          child: ListView.separated(
            ...
            itemCount: controller.approvalModel.value.data?.data?.length ?? 0,
            scrollDirection: Axis.vertical,
            itemBuilder: (context, index) {
              var fRData = controller.approvalModel.value.data?.data?[index];
              return Container(
                width: double.infinity,
                      ...
                      children: [
                        detalsview(
                          ...
                          tapApprovedDetailsdialog(() {
                            controller
                                .hireAuthorityApproval(fRData.id!.toInt());
                            print(fRData.id);
                            Get.back();
