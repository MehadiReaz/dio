...
import 'package:smart_hrm/core/utils/utils.dart';
...
class AuthUtils {
  ...
  static String socketurl="http://websocket.smartsoft-bd.com:40110";  //live url
  ...
  static Future _getSessionFromCache(String key) async {
    final prefs = await SharedPreferences.getInstance();
    if (prefs.containsKey(key)) { /// It can be optimized
